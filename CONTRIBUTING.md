...
Commit the input changes and the generated output together. Do not edit files under `apigen/{drs,lfsapi,bucketapi,metricsapi,internalapi}` by hand. Read the [OpenAPI code-generation guide](docs/operator-guide-code-generation.md) for the generated package layout and runtime serving path.
