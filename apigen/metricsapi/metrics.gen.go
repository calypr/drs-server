...
func (siw *ServerInterfaceWrapper) ListMetricsFiles(c fiber.Ctx) error {
	...
	if !siw.RawQueryOperations["ListMetricsFiles"] {
...
func (siw *ServerInterfaceWrapper) BulkMetricsFiles(c fiber.Ctx) error {
	...
	if !siw.RawQueryOperations["BulkMetricsFiles"] {
		// ------------- Optional query parameter "organization" -------------
		if paramValue := c.Query("organization"); paramValue != "" {
...
func (siw *ServerInterfaceWrapper) GetMetricsFile(c fiber.Ctx) error {
	...
	if !siw.RawQueryOperations["GetMetricsFile"] {
		// ------------- Optional query parameter "organization" -------------
		if paramValue := c.Query("organization"); paramValue != "" {
...
func (siw *ServerInterfaceWrapper) RecordProviderTransferEvents(c fiber.Ctx) error {
	...
	if !siw.RawQueryOperations["RecordProviderTransferEvents"] {
		// ------------- Optional query parameter "organization" -------------
		if paramValue := c.Query("organization"); paramValue != "" {
...
func (siw *ServerInterfaceWrapper) GetMetricsSummary(c fiber.Ctx) error {
	...
	if !siw.RawQueryOperations["GetMetricsSummary"] {
		// ------------- Optional query parameter "inactive_days" -------------
		if paramValue := c.Query("inactive_days"); paramValue != "" {
...
func (siw *ServerInterfaceWrapper) GetTransferBreakdown(c fiber.Ctx) error {
	...
	if !siw.RawQueryOperations["GetTransferBreakdown"] {
		// ------------- Optional query parameter "organization" -------------
		if paramValue := c.Query("organization"); paramValue != "" {
...
func (siw *ServerInterfaceWrapper) GetTransferSummary(c fiber.Ctx) error {
	...
	if !siw.RawQueryOperations["GetTransferSummary"] {
		// ------------- Optional query parameter "organization" -------------
		if paramValue := c.Query("organization"); paramValue != "" {
